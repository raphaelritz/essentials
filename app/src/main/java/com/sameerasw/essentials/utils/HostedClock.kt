...
class HostedClock private constructor(
    ...
    companion object {
        ...
        private fun create(
            ...
            runCatching { invoke(clock, "initialize", dark, 0f, 0f) }
        ...
        private fun face(
            ...
            runCatching { invoke(events, "onFontSettingChanged", textSize) }
            timeFormat?.let { runCatching { invoke(events, "onTimeFormatChanged", it) } }
    ...
    fun painted(
        ...
        return RectF(left, top, left + face.measured.x * scale, top + face.measured.y * scale)
    }
