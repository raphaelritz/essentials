...
class WidgetScraperService : Service() {
    ...
    override fun onStartCommand(
        ...
        if (type == "widget" || type == "music") {
            // A hosted widget only receives updates while its host is alive; a background process
            // is killed between updates and the provider's push then waits for the sticky service
            // to be restarted.
        ...
        try {
            ...
            manager?.createNotificationChannel(
                NotificationChannel(
                    ...
                    getString(R.string.pixel_searchbar_keep_alive_channel),
            ...
            val tapIntent =
                PendingIntent.getActivity(
                    this,
                    0,
                    Intent(this, PixelSearchbarSettingsActivity::class.java),
            ...
            val notification =
                NotificationCompat
                    ...
                    .setSmallIcon(R.drawable.rounded_search_24)
                    .setContentTitle(getString(R.string.pixel_searchbar_keep_alive_title))
                    .setContentText(getString(R.string.pixel_searchbar_keep_alive_text))
    ...
    /**
     * Provider pushes do not reach this off-screen host; AppWidgetHost.createView pulls the
     * system's current views for the widget, so the host view is re-created on a cadence.
     */
    ...
    private fun resolveForHostSize(remoteViews: RemoteViews): RemoteViews {
        ...
        val resolved =
            try {
                ...
                // refused by the platform and flagged by lint; HiddenApiBypass is initialised in
                // EssentialsApp.onCreate.
